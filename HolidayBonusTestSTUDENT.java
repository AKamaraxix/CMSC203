...
public class HolidayBonusTestSTUDENT {
	...
	private double[][] dataSet1 = {{3,2,1},{5,1},{4,5,6}};
	private double[][] dataSet2 = {{8,6,9,1},{6},{2,9,3},{4,5,4,2}};
	private double[][] dataSet3 = {{7.8,2.6,9.4,4.2},{6.9},{3.1,2.7,4.3},{10.6,7.9,8.3,4.7}};
	private double[][] dataSet4 = {{-8.5,-7.3,4.1},{-8.4,5.2},{1.3,-4.5},{-8.2,4.3,-9.9,3.6}};
	...
	public void tearDown() throws Exception {
		...
		public void testCalculateHolidayBonusA() {
			...
			assertEquals(17000.0,result[3],.001);
		...
		public void testCalculateHolidayBonusB() {
			...
			assertEquals(2250.0,result[3],.001);
			...
			assertEquals(3500.0,result[3],.001);
